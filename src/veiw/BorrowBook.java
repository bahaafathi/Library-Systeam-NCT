...
public class BorrowBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Students" }));

        jLabel3.setFont(new java.awt.Font("Calibri", 1, 25)); // NOI18N
        jLabel3.setText("Borrowed Book");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Book Name", "Book Name", "Book Name" }));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8-borrow-book-48.png"))); // NOI18N
